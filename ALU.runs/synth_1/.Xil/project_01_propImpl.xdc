set_property SRC_FILE_INFO {cfile:D:/VerilogProjects/Projects/ALU/project_01.xdc rfile:../../../project_01.xdc id:1} [current_design]
...
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { pb[0] }]; #IO_L20N_T3_34 Sch=BTN0
set_property src_info {type:XDC file:1 line:23 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { pb[1] }]; #IO_L24N_T3_34 Sch=BTN1
set_property src_info {type:XDC file:1 line:24 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { pb[2] }]; #IO_L18P_T2_34 Sch=BTN2
set_property src_info {type:XDC file:1 line:25 export:INPUT save:INPUT read:READ} [current_design]
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { pb[3] }]; #IO_L7P_T1_34 Sch=BTN3
